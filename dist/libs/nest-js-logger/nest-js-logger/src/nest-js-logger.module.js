...
const nest_js_logger_module_helper_1 = require("./helpers/nest-js-logger-module-helper");
...
let NestJsLoggerModule = NestJsLoggerModule_1 = class NestJsLoggerModule {
    static forRoot(options) {
        const winstonSettings = (0, nest_js_logger_module_helper_1.getWinstonSettingsForRoot)(options);
        return {
...
NestJsLoggerModule = NestJsLoggerModule_1 = __decorate([
    (0, common_1.Module)({
        imports: [
            nest_winston_1.WinstonModule.forRoot((0, nest_js_logger_module_helper_1.getWinstonSettingsForRoot)())
        ],
        providers: [nest_js_logger_service_1.NestJsLoggerService],
        exports: [nest_js_logger_service_1.NestJsLoggerService],
    })
